// Проект: EveHQ.Market
// Имя файла: SupportedMarket.cs
// GUID файла: 4C4B5E74-97D4-4825-A033-0CA77E5227E0
...
{
	public sealed class SupportedMarket
	{
		public const int JitaSystemId = 30000142;
		public const int TheForgeRegionId = 10000002;

		public readonly Dictionary<int, int> SystemToStationMap =
		...
		public readonly Dictionary<int, int> HubToRegionMap =
			new Dictionary<int, int>
			{
				{ 30000142, 10000002 }, // Jita IV - Moon 4 - Caldari Navy Assembly Plant
				{ 30002187, 10000043 }, // Amarr VIII (Oris) - Emperor Family Academy
				{ 30002659, 10000032 }, // Dodixie IX - Moon 20 - Federation Navy Assembly Plant
				{ 30002510, 10000030 }, // Rens VI - Moon 8 - Brutor Tribe Treasury
				{ 30002053, 10000042 } // Hek VIII - Moon 12 - Boundless Creation Factory
			};
